...
public class NhatKyBanHang extends javax.swing.JFrame {
    ...
    private void ShowTableHoaDon()
    {
        ...
        ResultSet rs=objHoaDon.getHoaDon();
        ...
        model.fireTableDataChanged();
         try {
            ...
            while (rs.next()) {
                ...
                vector.add(rs.getString("NgayThanhToan"));

                vector.add(rs.getString("MSCH"));
                 vector.add(rs.getString("MSKH"));
                  vector.add(rs.getString("Soseri"));
                   vector.add(rs.getString("type"));
                    vector.add(rs.getString("NgayTao"));
                model.addRow(vector);
            }
        } catch (SQLException exc) {
            System.out.println("Loi o NhatKyBanHangForm " + exc);
        }
    }
    /**
